...
const CreateStudentExpense = () => {
  ...
  const fetchStudentsByBatch = async () => {
    ...
    try {
      const response = await axios.get('http://localhost:65000/api/university-expenses/students-by-batch', {
        params: {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:65000/api/university-expenses/student-expense', payload);

...
const InvoiceManagement = () => {
  ...
  const generateAllInvoices = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post(`${API_URL}/api/fees/invoices/generate-all-students`, {
        degreeLevel,
  ...
  const generateInvoicesForStudent = async (studentId) => {
    ...
    try {
      ...
      const response = await axiosInstance.post(`${API_URL}/api/fees/invoices/generate-student`, {
        studentId,
        semesterType: 'past_current',
        includeFines: true,
        preventDuplicates: true
  ...
  const runCleanup = async () => {
    ...
    try {
      const response = await axiosInstance.post(`${API_URL}/api/fees/invoices/cleanup-duplicates`, {
        studentId: null 
      });
